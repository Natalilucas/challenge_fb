...
# Description: 
Verify the registration form is successfully submitted by filling in all fields with valid inputs.
...
# Description: 
Verify that the name field must be filled out.
...
# Description: 
Verify that the email field is mandatory and must be filled out.
...
# Description: 
Verify that the password field is mandatory and must be filled out.
...
# Description: 
Validate that it is not possible to log in without being registered.
...
# Description: 
Validate the success of logging in after successful registration.
...
# Description: 
Validate that it is not possible to log in with an incorrect password.
